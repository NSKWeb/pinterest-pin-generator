      ...
      <section className="mx-auto flex max-w-6xl flex-col gap-10 px-6 py-12 lg:flex-row">
        <div className="flex-1 space-y-6">
          ...
          <p className="text-base text-white/70">
            Choose your plan, set your topic, and generate fresh Pinterest pin ideas in seconds. The next
            generation of creator workflows starts here.
          </p>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-12">
        <div className="grid gap-6 md:grid-cols-3">
          {features.map((feature) => (
            <div key={feature.title} className="rounded-2xl border border-white/10 bg-slate-950/60 p-6">
